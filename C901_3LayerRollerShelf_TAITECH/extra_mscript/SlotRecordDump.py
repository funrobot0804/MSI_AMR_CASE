...
#
# ++++ START HERE ++++
now_ai_name = ai_name_prefix + "SlotRecordDump,S0"
me.stop(now_ai_name)
print(now_ai_name)
while(1):
    misc = me.get_misc()
...
#
# ++++ START HERE ++++
now_ai_name = ai_name_prefix + "SlotRecordDump,S1"
me.stop(now_ai_name)
print(now_ai_name)
while(1):
    misc = me.get_misc()
...
if isFail == True:
    me.stop("error,SlotRecordDump_ResetFail")
    os._exit(1)
...
#
# ++++ START HERE ++++
now_ai_name = ai_name_prefix + "SlotRecordDump,End"
me.stop(now_ai_name)
while(1):
    misc = me.get_misc()
    if now_ai_name == misc["status"]["name"][0:len(now_ai_name)]:
